...
SUBJ = 's74'
DATA_FILE = f'~/mice_example_data/WN_{SUBJ}_proj_4.mat'
MODEL_FILE = f'~/mice_example_data/{SUBJ}_WN_bridge_path_AEmodel.pth'
...
############# load model and skip the steps for model training
num_epochs = 100
